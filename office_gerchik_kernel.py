...
3) ATR: якщо day_used ≥75–80% — не по тренду (контртренд/ЛП або ПРОПУСК конкретного входу). Пошук нової структури на M15/M5 триває. Нова D1 лише перераховує day_used, не reset ATR.
